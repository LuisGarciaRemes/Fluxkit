...
extern const uint32_t RemoteConfigSettings_Dispose_m2083915538_MetadataUsageId;
...
extern "C" IL2CPP_METHOD_ATTR void CustomEventData_Destroy_m2070199408 (CustomEventData_t317522481 * __this, const RuntimeMethod* method)
{
	...
	}
	{
		...
		CustomEventData_Internal_Destroy_m3916992396(NULL /*static, unused*/, (intptr_t)L_2, /*hidden argument*/NULL);
...
IL_000e:
		{
			...
			V_0 = L_3;
			String_t* L_4 = KeyValuePair_2_get_Key_m430706138((KeyValuePair_2_t968067334 *)(&V_0), /*hidden argument*/KeyValuePair_2_get_Key_m430706138_RuntimeMethod_var);
			V_2 = L_4;
			RuntimeObject * L_5 = KeyValuePair_2_get_Value_m4041454723((KeyValuePair_2_t968067334 *)(&V_0), /*hidden argument*/KeyValuePair_2_get_Value_m4041454723_RuntimeMethod_var);
			V_3 = L_5;
...
IL_015a:
		{
			String_t* L_49 = KeyValuePair_2_get_Key_m430706138((KeyValuePair_2_t968067334 *)(&V_0), /*hidden argument*/KeyValuePair_2_get_Key_m430706138_RuntimeMethod_var);
...
IL_0291:
		{
			...
			NullCheck(L_93);
			bool L_94 = InterfaceFuncInvoker0< bool >::Invoke(0 /* System.Boolean System.Collections.IEnumerator::MoveNext() */, IEnumerator_t1853284238_il2cpp_TypeInfo_var, L_93);
			if (L_94)
			{
				goto IL_000e;
			}
...
extern "C" IL2CPP_METHOD_ATTR void UnityAnalyticsHandler_Destroy_m945739537 (UnityAnalyticsHandler_t3011359618 * __this, const RuntimeMethod* method)
{
	...
	{
		intptr_t L_2 = __this->get_m_Ptr_0();
		UnityAnalyticsHandler_Internal_Destroy_m2102025341(NULL /*static, unused*/, (intptr_t)L_2, /*hidden argument*/NULL);
		__this->set_m_Ptr_0((intptr_t)(0));
	}
...
extern "C" IL2CPP_METHOD_ATTR void RemoteConfigSettings_Destroy_m1854335118 (RemoteConfigSettings_t1247263429 * __this, const RuntimeMethod* method)
{
	...
	{
		intptr_t L_2 = __this->get_m_Ptr_0();
		RemoteConfigSettings_Internal_Destroy_m1072151938(NULL /*static, unused*/, (intptr_t)L_2, /*hidden argument*/NULL);
		__this->set_m_Ptr_0((intptr_t)(0));
	}
...
extern "C" IL2CPP_METHOD_ATTR void RemoteConfigSettings_Dispose_m2083915538 (RemoteConfigSettings_t1247263429 * __this, const RuntimeMethod* method)
{
	...
	if (!s_Il2CppMethodInitialized)
	{
		il2cpp_codegen_initialize_method (RemoteConfigSettings_Dispose_m2083915538_MetadataUsageId);
		s_Il2CppMethodInitialized = true;
	}
	{
		RemoteConfigSettings_Destroy_m1854335118(__this, /*hidden argument*/NULL);
